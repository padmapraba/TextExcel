...
public class TestsAll {
   ...
   public static class A_Checkpoint3
   {
      ...
      public void testPercentCell()
      {
         ...
         assertEquals("date inspection text", "11.25%", dateCell.fullCellText());
      }
      ...
      public void testRealCellTruncation()
      {
         ...
         assertEquals("real moderate inspection", moderate + ".0", moderateCell.fullCellText());
         ...
         assertEquals("real precise percent inspection", "7.87878%", precisePerCell.fullCellText());
      }        
   }
...
*/
   ...
   public static class B_Final
   {
      ...
      public void testFormulaAssignment()
      {
         ...
         assertEquals("inspection 2", formula2.toUpperCase(), cell2.fullCellText());
         assertEquals("cell length 3", 10, cell3.abbreviatedCellText().length());
         assertEquals("inspection 3", formula3.toUpperCase(), cell3.fullCellText());
      }
   ...
   */
   ...
   public static class C_Final
   {
      ...
      public void testSortDMultiType2D()
      {
         ...
         String[] sortedVals = { "-190.1", "-13.2", "-0.02", "1.0%", "101.0%", "2.2", "19.2", "88.2", "60710.0%", "607.2" };
         int iSortedVals = 0;
   ...
   public static class C_ExtraCreditHeterogeneousSorting
   {
      ...
      public void testSortaHeterogeneous() 
      {
         ...
         String[] sortedVals = { "", "", "", "", "", "", "", "", "", "",  
                                ...
                                "-190.1", "-13.2", "-0.02", "1.0%", "101.0%", "2.2", "19.2", "88.2", "60710.0%", "607.2" };
         int iSortedVals = 0;
